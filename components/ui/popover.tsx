...
const PopoverContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Content> & { avoidCollisions?: boolean }
>(({ className, align = "center", sideOffset = 4, avoidCollisions = true, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      avoidCollisions={avoidCollisions}  // Use the prop value
      className={cn(
